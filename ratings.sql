...
COPY public.movies (movie_id, title, overview, release_date, post_path) FROM stdin;
1	Frozen	two sisters prove love conquers all	2007-02-20 00:00:00	what is this
\.
